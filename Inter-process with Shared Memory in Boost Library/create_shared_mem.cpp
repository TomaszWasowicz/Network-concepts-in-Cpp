/*
Boost C++ Library Interprocess Mechanism is designed for Sharing information 
between processes. This example using shared memory to communicate between 2 processes.
Processes And Threads Boost.
Interprocess does not work only with processes but also with threads.Boost.Interprocess 
